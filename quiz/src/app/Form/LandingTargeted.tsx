            ...
            <div style={{ minHeight: '100vh', background: '#f8fafc', padding: 0, margin: 0, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'flex-end', paddingBottom: 32 }}>
                        <button
                            style={{
                                ...
                                borderRadius: 999,
                                border: 'none',
                                boxShadow: '0 2px 10px 0 #2563eb33',
                                cursor: 'pointer',
                                margin: 0,
                            ...
                            onMouseOver={e => {
                                (e.currentTarget as HTMLButtonElement).style.boxShadow = '0 4px 18px 0 #10b98133';
                                (e.currentTarget as HTMLButtonElement).style.transform = 'translateY(-2px) scale(1.03)';
                            }}
                            onMouseOut={e => {
                                (e.currentTarget as HTMLButtonElement).style.boxShadow = '0 2px 10px 0 #2563eb33';
                ...
                <style>{`
                    ...
                    @media (max-width: 600px) {
                        ...
                        label {
                            flex-direction: column !important;ß
